...
const Contact = () => {
  return (
    <div id='contact' className='h-screen bg-[#1d1d20] py-16 font-poppin'>
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-[#1d1d20]">
            <div className="text-center px-6">
                <h2 className="text-4xl text-center font-bold bg-gradient-to-tl bg-red-600 from-white bg-clip-text text-transparent">Contact Us</h2>
                <p className="text-sm text-white mt-4">Have some big idea or brand to develop and need help?</p>
            </div>

            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[2px_2px_10px_black] hover:shadow-[2px_2px_20px_white] transition-all duration-700 rounded-lg mt-10">
                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul className="mt-16 space-y-8">
                        <li className="flex items-center">
                            ...
                            <a href="/" className="text-sm text-white ml-4">
                                vinoddhaware@gmail.com
                            </a>
                        </li>
                        <li className="flex items-center">
                ...
                <div className="p-4 lg:col-span-2">
                    <form action='https://formspree.io/f/mkgnvnwr' method='POST'>
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <label htmlFor="radio1"
                                            ...
                                            <span className="border-[4px] rounded-full w-full h-full"></span>
                                        </label>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-white ml-4">Technical Support</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-white ml-4">Website Feedback</p>
                                    </div>
                                </div>
                            </div>
                        </div>
